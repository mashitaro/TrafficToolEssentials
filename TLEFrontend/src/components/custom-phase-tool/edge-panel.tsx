...
export default function EdgePanel(props: {data: EdgeInfo, index: number, position: ScreenPoint}) {
  ...
  // V130: Bicycle lanes disabled in UI - bicycles follow car signals in CS2
  // Backend code remains for future compatibility when CS2 adds separate bicycle signals
  // const bicycleLaneCount = props.data.m_BicycleLaneCount ?? 0;
  const bicycleLaneCount = 0; // V130: Disabled - bicycles follow car signals
