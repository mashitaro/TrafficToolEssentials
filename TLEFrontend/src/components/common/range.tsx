...
const Thumb = styled.div<{active: boolean}>`
  background-color: rgba(100, 180, 255, 1);  /* Main Menu Blue */
  border-radius: 50%;
  width: 1.8em;   /* Larger - was 1.0em */
  height: 1.8em;  /* Larger - was 1.0em */
  margin-left: -0.9em;  /* Adjusted for larger thumb */
  box-shadow: 0 2rem 6rem rgba(0, 0, 0, 0.3);  /* Subtle shadow */
  transform: ${props => props.active ? "scale3d(1.1, 1.1, 1)" : "none"};
  transition: all 150ms ease-in-out;  /* Smooth animation */
  &:hover {
    transform: scale3d(1.15, 1.15, 1);
    background-color: rgba(120, 200, 255, 1);  /* Lighter on hover */
    box-shadow: 0 3rem 10rem rgba(100, 180, 255, 0.4);
  }
`;
