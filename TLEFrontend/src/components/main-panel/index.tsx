  ...
  return (
    <>
      ...
      >
        ...
        <MainContainer>
          {/* Header nur anzeigen wenn NICHT FunctionSelection */}
          {panel.state != MainPanelState.FunctionSelection && <Header title={panel.title} image={panel.image} onMouseDown={mouseDownHandler} />}
          {/* FUNCTION SELECTION - Neuer State mit integriertem Header */}
