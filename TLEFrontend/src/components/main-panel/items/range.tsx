...
export default function MainPanelRange(props: {data: MainPanelItemRange, tooltip?: React.ReactNode}) {
    ...
    <Container>
      <TitleContainer>
        <TitleDim 
          ...
          secondaryText={!textFieldActive ? getString(locale, props.data.valuePrefix) + `${Math.round(value * 100) / 100}` + getString(locale, props.data.valueSuffix) : ""} 
