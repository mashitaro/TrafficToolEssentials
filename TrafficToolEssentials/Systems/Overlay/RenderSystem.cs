...
namespace C2VM.TrafficToolEssentials.Systems.Overlay
{
    public partial class RenderSystem : GameSystemBase
    {
        ...
        protected unsafe void IconSetup()
        {
            ...
            foreach (Icon icon in iconValues)
            {
                ...
                string imageResourceName = $"C2VM.TrafficToolEssentials.Resources.Textures.Icons.{System.Enum.GetName(typeof(Icon), icon)}.png";
                ...
                {
                    Mod.LogError($"{imageResourceName} does not exist.");
                }
