...
public partial class PatchedTrafficLightSystem : GameSystemBase
{
    ...
    // See: https://www.virustotal.com/ for verification
    [BurstCompile]
        ...
        public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
        {
            ...
            for (int i = 0; i < nativeArray2.Length; i++)
            {
                ...
                if (customTrafficLights.GetPatternOnly() == CustomTrafficLights.Patterns.CustomPhase && i < customPhaseDataBufferAccessor.Length && (trafficLights.m_Flags & TrafficLightFlags.MoveableBridge) == 0)
                {
                    ...
                    // V144: Update flow history with real LaneFlow data
                    CustomStateMachine.UpdateFlowHistory(this, unfilteredChunkIndex, nativeArray[i], subLanes);
            ...
            {
                // V198.1: Always dispose even on exception
                if (laneSignals.IsCreated) laneSignals.Dispose();
            }
        }
