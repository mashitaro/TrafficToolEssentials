...
public struct ExtraTypeHandle
{
    ...
    /// <summary>V151: Intersection-level flow history for sparkline visualization (persistent)</summary>
    public ComponentLookup<PersistentTrafficHistory> m_PersistentTrafficHistory;
    ...
    public void AssignHandles(ref SystemState state)
    {
        ...
        m_PersistentTrafficHistory = state.GetComponentLookup<PersistentTrafficHistory>(isReadOnly: false); // V151
    ...
    public ExtraTypeHandle Update(ref SystemState state)
    {
        ...
        m_PersistentTrafficHistory.Update(ref state); // V151
