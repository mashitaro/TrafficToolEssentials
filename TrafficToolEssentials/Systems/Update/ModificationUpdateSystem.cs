...
namespace C2VM.TrafficToolEssentials.Systems.Update;

public partial class ModificationUpdateSystem : GameSystemBase
{
    private C2VM.TrafficToolEssentials.Systems.UI.UISystem m_UISystem;

    protected override void OnCreate()
    {
        base.OnCreate();
        m_UISystem = World.GetOrCreateSystemManaged<C2VM.TrafficToolEssentials.Systems.UI.UISystem>();
    }
