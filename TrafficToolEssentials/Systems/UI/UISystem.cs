...
public partial class UISystem : UISystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (m_PendingRedrawTime > 0 && UnityEngine.Time.time >= m_PendingRedrawTime)
        {
            ...
            RedrawGizmo();
            Mod.m_Log.Info("[DelayedRedraw] Gizmo redrawn after paste");
        }
        ...
        // Live update for Green Wave Dashboard
        if (m_GreenWaveDashboardActive && m_MainPanelBinding != null)
        {
    ...
    protected override void OnGameLoadingComplete(Colossal.Serialization.Entities.Purpose purpose, GameMode mode)
    {
        ...
        Mod.m_Log.Info("[UISystem] Game loading complete, starting post-load refresh counter");
    }
    ...
    public void SimulationUpdate()
    {
        ...
        if (m_PostLoadRefreshCounter > 0)
        {
            ...
            {
                m_MainPanelBinding.Update();
                Mod.m_Log.Info("[UISystem] Post-load refresh: Updated MainPanelBinding for sync groups");
            }
        }
