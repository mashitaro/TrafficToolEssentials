...
using static C2VM.TrafficToolEssentials.Systems.UI.UITypes;
...
public partial struct NodeUtils
{
    public struct EdgeInfo : IJsonWritable
    {
        ...
        // V126: Simplified - bicycles don't have direction-specific lanes in CS2
        // When green, cyclists can go any direction from this approach
