...
public class LocalisationUtils
{
    ...
    public void SetLocale(string locale)
    {
        ...
        string resourceName = "C2VM.TrafficToolEssentials.Resources.Localisations." + m_Locale + ".json";
        using Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(resourceName);
        if (stream == null)
        {
            Mod.LogError($"{resourceName} does not exist.");
            return;
        }
    ...
    public void AddToDictionary(Colossal.Localization.LocalizationDictionary dictionary)
    {
        ...
        dictionary.Add(Mod.m_Settings.GetSettingsLocaleID(), "Traffic Tool Essentials");
        ...
        dictionary.Add(Mod.m_Settings.GetOptionLabelLocaleID("m_DebugLogging"), this.GetString("DebugLoggingLabel"));
        ...
        dictionary.Add(Mod.m_Settings.GetOptionLabelLocaleID("m_TleVersion"), "Traffic Tool Essentials");
        dictionary.Add(Mod.m_Settings.GetOptionLabelLocaleID("m_LaneSystemVersion"), "LaneSystem (C2VM.CommonLibraries)");
        ...
        dictionary.Add(Mod.m_Settings.GetOptionLabelLocaleID("m_IntersectionToolKeyboardBinding"), this.GetString("IntersectionToolKeyboardBindingLabel"));
        ...
        dictionary.Add(Mod.m_Settings.GetOptionDescLocaleID("m_DebugLogging"), this.GetString("DebugLoggingDesc"));
        ...
        dictionary.Add(Mod.m_Settings.GetOptionDescLocaleID("m_IntersectionToolKeyboardBinding"), this.GetString("IntersectionToolKeyboardBindingDesc"));
