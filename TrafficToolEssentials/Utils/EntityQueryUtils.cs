...
namespace C2VM.TrafficToolEssentials.Utils
{
    public class EntityQueryUtils
    {
        ...
        public static EntityQueryBuilder GetEntityQueryBuilder(EntityQuery oldQuery, NativeList<ComponentType> none)
        {
            ...
            var builder = GetEntityQueryBuilder(oldQuery, empty, none, empty, empty, empty, empty);
            // V205: Dispose empty list after use
            empty.Dispose();
            return builder;
        }
        ...
        )
        {
            ...
            for (int i = 0; i < descArray.Length; i++)
            {
                ...
                // V205: Dispose all old* NativeLists after use
                oldAny.Dispose();
                oldNone.Dispose();
                oldAll.Dispose();
                oldDisabled.Dispose();
