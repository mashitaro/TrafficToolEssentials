...
public struct CustomPhaseData : IBufferElementData, ISerializable
{
    ...
    {
        m_SchemaVersion = 2; // V126: Bicycle Support
    ...
    {
        return m_CarLaneOccupied + m_TrackLaneOccupied + m_PedestrianLaneOccupied + m_BicycleLaneOccupied;
    }
}